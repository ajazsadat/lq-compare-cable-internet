  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f8fafc]">
      ...
      <section className="border-b border-slate-200 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-center">
          ...
          >
            ...
            Call to get assistance — (888) 908-7350
          </a>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        ...
        <div className="mt-16 rounded-2xl border border-emerald-500/30 bg-white p-7 md:p-9 flex flex-col md:flex-row md:items-center md:justify-between gap-6 shadow-lg">
          <div>
