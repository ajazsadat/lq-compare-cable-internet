      ...
      <section className="relative w-full h-[70vh] min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-10">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold text-slate-900 mb-6 tracking-tight leading-tight drop-shadow-lg">
            Compare Multiple <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-emerald-300">Internet Plans</span> In One Place.
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:8889594513"
              className="inline-flex items-center justify-center text-center px-8 py-4 text-lg font-bold rounded-full text-white bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-500 hover:to-emerald-500 shadow-[0_0_20px_rgba(6,182,212,0.4)] transition-all transform hover:-translate-y-1"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#ffffff] rounded-3xl p-8 border border-slate-200 hover:border-emerald-500/30 transition-all duration-300 hover:shadow-[0_0_30px_rgba(6,182,212,0.15)] flex flex-col h-full relative overflow-hidden group">
              ...
              <div className="w-16 h-16 bg-gradient-to-br from-teal-500/20 to-emerald-400/20 rounded-2xl flex items-center justify-center mb-6 text-emerald-400 border border-emerald-500/20 group-hover:scale-110 transition-transform">
            ...
            {/* Box 2 */}
            <div className="bg-[#ffffff] rounded-3xl p-8 border border-slate-200 hover:border-teal-500/30 transition-all duration-300 hover:shadow-[0_0_30px_rgba(59,130,246,0.15)] flex flex-col h-full relative overflow-hidden group">
              ...
              <div className="w-16 h-16 bg-gradient-to-br from-teal-600/20 to-indigo-400/20 rounded-2xl flex items-center justify-center mb-6 text-teal-400 border border-teal-500/20 group-hover:scale-110 transition-transform">
            ...
            {/* Box 3 */}
            <div className="bg-[#ffffff] rounded-3xl p-8 border border-slate-200 hover:border-purple-500/30 transition-all duration-300 hover:shadow-[0_0_30px_rgba(168,85,247,0.15)] flex flex-col h-full relative overflow-hidden group">
            ...
            <div className="w-full lg:w-1/2">
              <div className="bg-[#ffffff] rounded-3xl p-10 border border-slate-200 shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <a
                    href="tel:8889594513"
                    className="flex items-center justify-center text-center w-full px-8 py-5 text-xl font-bold rounded-xl text-white bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-500 hover:to-emerald-500 shadow-lg transition-all transform hover:-translate-y-1"
                  >
                    <svg className="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                    Compare & Call (888) 959-4513
                  </a>
                  <p className="text-xs text-slate-500 mt-4 text-center">Internet comparison & ordering assistance.</p>
                </div>
              </div>
            </div>
