          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="bg-[#ffffff] p-6 rounded-2xl border border-slate-200 flex items-start group hover:border-emerald-500/30 transition-colors">
                  <div className="w-12 h-12 bg-teal-500/10 rounded-xl flex items-center justify-center mr-4 group-hover:bg-teal-500/20 transition-colors">
                ...
                <div className="bg-[#ffffff] p-6 rounded-2xl border border-slate-200 flex items-start group hover:border-emerald-500/30 transition-colors">
                  ...
                  <div>
                    ...
                    <a href="tel:8889594513" className="text-xl font-bold text-emerald-400 hover:text-emerald-300 transition-colors">
                      (888) 959-4513
                    </a>
                  </div>
                </div>
            ...
            <div className="bg-[#ffffff] rounded-3xl p-8 border border-slate-200 shadow-2xl relative">
              ...
              <form className="space-y-6 relative z-10">
                ...
                <button type="button" className="w-full py-4 px-6 text-lg text-center font-bold rounded-lg text-slate-900 bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-500 hover:to-emerald-500 shadow-[0_0_20px_rgba(6,182,212,0.3)] transition-all transform hover:-translate-y-1">
                  Send Message
                </button>
              </form>
            </div>
