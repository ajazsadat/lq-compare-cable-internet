...
const faqs = [
  {
    q: 'Is LQcomparecableinternet part of Spectrum or Charter?',
  ...
  {
    q: 'Why compare through LQcomparecableinternet instead of going straight to Spectrum?',
    a: "Going direct to one provider means you only see their pitch. We lay out Spectrum's pricing next to other providers so you can see how it actually compares before deciding.",
  },
  {
    q: 'Can you tell me what Spectrum plans are available at my address?',
  ...
  {
    q: 'Are the prices shown here exactly what Spectrum charges?',
...
export default function SpectrumFaq() {
