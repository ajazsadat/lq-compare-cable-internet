    ...
    <form className={className} onSubmit={handleSubmit}>
      ...
      <div className="flex items-start gap-3">
        ...
        <label htmlFor={`${idPrefix}-consent`} className="text-xs text-slate-600 leading-relaxed">
          ...
          provided by LQcomparecableinternet. By providing my phone number, I agree to receive text
          messages and calls from LQcomparecableinternet. Consent is not a condition of purchase.
        </label>
      </div>
